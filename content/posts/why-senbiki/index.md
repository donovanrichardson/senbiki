...
- Senbiki (線引き) literally means drawing a line. 
  ...
  - The goal was to limit urban development (residential, etc) only to areas that had the infrastructure that could best support
    - based on conditions and infra improvements, the urbanization-promotion/control areas could be expanded or shrunk.
- Though the above is the origin of the term wrt japanese urban planning
do not publish